    ...
    csstree.walk(ast, {
        ...
        enter: function(node) {
            ...
            if (error) {
                ...
                if (error.name !== 'SyntaxMatchError' && error.name !== 'SyntaxReferenceError') {
                    return;
                }
...
exports.addon = function(renderer) {
    ...
    if (process.env.NODE_ENV === 'production') {
        console.warn(
            'You are using nano-css "validate" in production. ' + 'This addon is meant to be used only in development.'
        );
    }
